...
- Dates: from ~29 August 2026. 3 weeks committed, extendable to 4 or 5 weeks if there is good reason.
- Primary goal: complete a lead rope climbing course somewhere, buy their own climbing gear, then optionally climb elsewhere. The course is the anchor; extra climbing is a bonus.
