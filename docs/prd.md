...
- Shape: booked in via Sydney, Singapore and Vienna (1-3 Sept); Dolomites then Arco for the first fortnight; Slovenia (~19-24 Sept); a German split (Fran to Berlin, Sam via Munich/Augsburg, then Berlin together); Kalymnos finale with the 2-4 Oct festival; home from Athens ~5 Oct (maybe the 6th, most likely not the 7th).
